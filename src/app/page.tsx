          ...
          <div className="text-center">
            <div className="flex justify-center mb-8">
              <div className="relative">
                ...
                <div className="relative bg-white/80 backdrop-blur-sm rounded-full p-4 shadow-lg">
            ...
            <h1 className="text-4xl sm:text-6xl lg:text-7xl font-bold text-gray-900 mb-6 leading-tight">
              ...
              <br />
              <span className="text-gray-800">A lifetime of emotions.</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link href="/auth">
                <button className="group relative bg-gradient-to-r from-purple-600 to-blue-600 text-white px-8 py-4 rounded-full text-lg font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-6 max-w-4xl mx-auto">
            {moods.map((mood, index) => (
              <div 
                key={index} 
                className="group relative bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300 cursor-pointer"
              >
                <div className="text-center">
                  <div className="text-4xl mb-3 group-hover:scale-110 transition-transform">
                    {mood.emoji}
                  </div>
                  <div className={`text-sm font-medium px-3 py-1 rounded-full ${mood.color}`}>
                    {mood.label}
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div 
                key={index}
                className="group bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300"
              >
                <div className="flex items-center mb-4">
                  <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-white p-3 rounded-xl group-hover:scale-110 transition-transform">
                    {feature.icon}
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg">
                <div className="flex items-center mb-4">
                  ...
                  <span className="font-semibold text-gray-900">Mood Trends</span>
                </div>
                <div className="h-32 bg-gradient-to-r from-green-200 to-blue-200 rounded-lg flex items-end p-4 space-x-2">
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg">
                <div className="flex items-center mb-4">
                  ...
                  <span className="font-semibold text-gray-900">Daily Entries</span>
                </div>
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    <span className="text-2xl">😃</span>
                    <span className="text-gray-600 text-sm">"Finally finished my first marathon today!"</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <span className="text-2xl">🙂</span>
                    <span className="text-gray-600 text-sm">"Coffee with mom was exactly what I needed."</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <span className="text-2xl">😐</span>
                    <span className="text-gray-600 text-sm">"Another quiet Tuesday, but that's okay."</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg">
              <div className="flex items-center mb-6">
                ...
                <span className="font-semibold text-gray-900">Word Cloud Memories</span>
              </div>
              <div className="text-center space-y-4">
                <div className="flex justify-center items-center space-x-4 flex-wrap">
                  <span className="text-2xl font-bold text-purple-600">grateful</span>
                  <span className="text-lg text-blue-500">family</span>
                  <span className="text-xl font-semibold text-green-600">growth</span>
                </div>
                <div className="flex justify-center items-center space-x-4 flex-wrap">
                  <span className="text-lg text-orange-500">adventure</span>
                  <span className="text-3xl font-bold text-pink-600">love</span>
                  <span className="text-lg text-indigo-500">learning</span>
                </div>
                <div className="flex justify-center items-center space-x-4 flex-wrap">
                  <span className="text-xl text-teal-600">peaceful</span>
                  <span className="text-lg font-semibold text-red-500">challenge</span>
                  <span className="text-2xl font-bold text-yellow-600">joy</span>
                </div>
              </div>
            </div>
          </div>
